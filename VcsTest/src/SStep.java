...
/**
 * Servlet implementation class for Servlet: SStep
 *
 */
 public class SStep extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			try
			{
				mypath="/VcsTest/Stud/StudHome.jsp";

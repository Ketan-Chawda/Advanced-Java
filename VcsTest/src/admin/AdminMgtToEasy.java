...
/**
 * Servlet implementation class for Servlet: AdminMgtToEasy
 *
 */
 public class AdminMgtToEasy extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public AdminMgtToEasy() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			try
			{
				...
				kout.println("<form action='/VcsTest/AdminMgtToEasyHelp' method='post'>");
				while(rs.next())
				{
					...
					kout.println("<tr><td><input type='submit' value='To Allumni'><td>Sr No:<td>Management Name<td>Gender<td>Coursename<td>Country<td>City<td>");

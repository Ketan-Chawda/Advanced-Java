...
/**
 * Servlet implementation class for Servlet: AdminLockEasy
 *
 */
 public class AdminLockEasy extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public AdminLockEasy() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			try
			{
				...
				ResultSet rs=st.executeQuery("select * from login_master where locked='no'");
				
				int c=1;
				kout.println("<center><table align='right' width=95% border=2 bordercolor='black'>");
				kout.println("<form action='/VcsTest/AdminLockEasyHelp' method='post'>");
				while(rs.next())
				{
					...
					kout.println("<tr><td><input type='submit' value='Lock'><td>Sr No:<td>Role<td>Course<td>Priority");
				...
				if(c==1)
				kout.println("<br><br><br><h1>Sorry No Users Account Is Unlocked OR No User Exists");
		}
		catch(Exception e)
		{

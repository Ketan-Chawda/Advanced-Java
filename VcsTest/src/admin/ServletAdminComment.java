 ...
 *
 */
 public class ServletAdminComment extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public ServletAdminComment() {
		super();
	}   	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String query="select * from blog_master where bid='"+bid+"'";						
			try
			{
                ...
                kout.println("<form name=upd id=upd method=post action=/VcsTest/Admin/AdminCommentCreate.jsp>");
		...
		finally
		{
			...
			kout.println("<form id=vcs method=post action=/VcsTest/Admin/AdminCommentCreate.jsp>");

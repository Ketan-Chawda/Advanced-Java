...
/**
 * Servlet implementation class for Servlet: AdminFacultyConfirmEasy
 *
 */
 public class AdminFacultyConfirmEasy extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public AdminFacultyConfirmEasy() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			try
			{
				...
				kout.println("<form action='/VcsTest/AdminFacultyConfirmEasyHelp' method='post'>");
				while(rs.next())
				{
					...
					kout.println("<tr><td><input type='submit' value='Confirm'><td>Sr No:<td>Faculty Name<td>Gender<td>Coursename<td>Country<td>City<td>Registration Date<td>");

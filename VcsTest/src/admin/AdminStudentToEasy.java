...
/**
 * Servlet implementation class for Servlet: AdminStudentToEasy
 *
 */
 public class AdminStudentToEasy extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public AdminStudentToEasy() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Student Who Are Currently Studying In VCS</title></head>");
		...
		try
		{
			...
			try
			{
				...
				kout.println("<form action='/VcsTest/AdminStudentToEasyHelp' method='post'>");
				while(rs.next())
				{
					...
					kout.println("<tr><td><input type='submit' value='To Alumni'><td>Sr No:<td>Student Name<td>Gender<td>Coursename<td>Country<td>City<td>");

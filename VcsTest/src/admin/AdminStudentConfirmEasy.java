...
/**
 * Servlet implementation class for Servlet: AdminStudentConfirmEasy
 *
 */
 public class AdminStudentConfirmEasy extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public AdminStudentConfirmEasy() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Students Whose Request Are Pending For Admission In VCS</title></head>");
		...
		try
		{
			...
			try
			{
				...
				while(rs.next())
				{
					...
					kout.println("<tr><td><input type='submit' value='Confirm'><td>Sr No:<td>Student Name<td>Gender<td>Coursename<td>Country<td>City<td>Registration Date<td>");

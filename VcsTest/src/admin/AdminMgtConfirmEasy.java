...
/**
 * Servlet implementation class for Servlet: AdminMgtConfirmEasy
 *
 */
 public class AdminMgtConfirmEasy extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public AdminMgtConfirmEasy() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			try
			{
				...
				kout.println("<form action='/VcsTest/AdminMgtConfirmEasyHelp' method='post'>");
				while(rs.next())
				{
					...
					kout.println("<tr><td><input type='submit' value='Confirm'><td>Sr No:<td>Management Name<td>Gender<td>Qualification<td>Country<td>City<td>Registration Date<td>");

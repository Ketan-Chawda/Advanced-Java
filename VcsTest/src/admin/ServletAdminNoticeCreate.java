...
/**
 * Servlet implementation class for Servlet: ServletAdminNoticeCreate
 *
 */
 public class ServletAdminNoticeCreate extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public ServletAdminNoticeCreate() {
		super();
	}   	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		String mynid="",tprior="5";
		String tforcourse="",tnoticefrom="",tnoticeto="";
		String tnmsg="",tndate="",query1="",query2="";
		...
		if(mycon!=null)
		{
			try
			{
				...
				kout.println("<br><h1>Notice Creation By Admin</h1>");

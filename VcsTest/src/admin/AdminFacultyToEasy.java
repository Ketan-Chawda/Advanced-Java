...
/**
 * Servlet implementation class for Servlet: AdminFacultyToEasy
 *
 */
 public class AdminFacultyToEasy extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public AdminFacultyToEasy() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Faculty Who Are Currently Working In VCS</title></head>");
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr><td colspan=75%><blockquote><h2>"+Styles.ccase("Operation On : "+" Activity Organized")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				kout.println("<br><br><br>**************************************************************************************************************</center><br>");
				//kout.println("<br><br><h1>Faculty Who Are Currently Working In VCS</h1>");

				st=mycon.createStatement();
				ResultSet rs=st.executeQuery("select * from faculty_master");
				int c=1;
				kout.println("<center><table align='right' width=95% border=2 bordercolor=black>");
				kout.println("<form action='/VcsTest/AdminFacultyToEasyHelp' method='post'>");
				while(rs.next())
				{
					...
					kout.println("<tr><td><input type='submit' value='To Alumni'><td>Sr No:<td>Faculty Name<td>Gender<td>Qualification<td>Country<td>City<td>");
				...
				if(c==1)
					kout.println("<br><br><br><h1>Sorry No Faculty Is Currently Working With VCS");
			}
			catch(Exception k)
			{
			...
			kout.println("<br><br><h2><center>Sorry Connection Is Not Active Now</center>");
			}
			catch(Exception k)
			{
				System.err.println(k);

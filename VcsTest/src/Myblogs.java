...
/**
 * Servlet implementation class for Servlet: Myblogs
 *
 */
 public class Myblogs extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr><td colspan=150><blockquote><h2>"+Styles.ccase("Report Title : "+"View Blogs")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");

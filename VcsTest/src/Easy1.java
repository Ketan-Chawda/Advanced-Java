...
/**
 * Servlet implementation class for Servlet: Easy1
 *
 */
 public class Easy1 extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			try
			{
				...
				mypath="/VcsTest/Admin/AdminHome.jsp";
				else if(myrole.compareToIgnoreCase("management")==0)
				mypath="/VcsTest/Mgt/MgtHome.jsp";

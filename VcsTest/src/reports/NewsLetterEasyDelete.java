...
/**
 * Servlet implementation class for Servlet: NewsLetterEasyDelete
 *
 */
 public class NewsLetterEasyDelete extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public NewsLetterEasyDelete() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Easy Deletion Of NewsLetter By Admin In VCS</title></head>");
		...
		try
		{
			...
			{	
				...
				kout.println("<tr><td colspan=75%><blockquote><h2>"+Styles.ccase("Operation On : "+" NewsLetter")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				kout.println("<br><br><br>**************************************************************************************************************</center><br>");
				//kout.println("<br><br><h1>View NewsLetter By Admin In VCS</h1>");
				...
				kout.println("<form action='/VcsTest/NewsLetterEasyHelp' method='post'>");
				while(rs.next())
				{
					...
					if(c%2==1)
					kout.println("<tr><td colspan=95%><center><h1>NewsLetter Id : " +str+"</center></h1>");
					else
					kout.println("<tr><td colspan=95%><center><h2>NewsLetter Id : "+str+"</center></h2>");
					kout.println("<tr><td><input type='submit' value='Delete'><td>Sr No:<td>News Date<td>NewsLetter Message<td>");

...
/**
 * Servlet implementation class for Servlet: NoticeReport
 *
 */
 public class NoticeReport extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>All Notice Only For Admin</title></head>");
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr><td colspan=150><blockquote><h2>"+Styles.ccase("Report Title : "+"All Notice")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				...
				while(rs.next())
				{
					...
					kout.println("<tr><td>Sr No:<td>Notice From<td>Notice<td>To<td>Notice Date<td>");
					kout.println("<tr><td>"+c);
					kout.println("<td>"+rs.getString("noticefrom"));
					kout.println("<td>"+rs.getString("noticeto"));

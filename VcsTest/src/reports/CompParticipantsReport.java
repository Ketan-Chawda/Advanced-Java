...
/**
 * Servlet implementation class for Servlet: CompParticipantsReport
 *
 */
 public class CompParticipantsReport extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public CompParticipantsReport() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>View Competition's Participants In VCS</title></head>");
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr><td colspan=150><blockquote><h2>"+Styles.ccase("Report Title : "+"Competition's Participants")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				...
				while(rs.next())
				{
					...
					while(rs1.next())
					{
					kout.println("<tr><td>Total:<td>User Id<td>Involved As<td>");
					...
					rs1.close();
					if(k==1)
					kout.println("<tr><td colspan=11>Sorry No Participants Are Available For This Competition Now");
					c=c+1;
					kout.println("<tr><td colspan=100%><center>"+Fortable.display(33,"<<->>"));

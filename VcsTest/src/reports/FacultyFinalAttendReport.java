...
/**
 * Servlet implementation class for Servlet: FacultyFinalAttendReport
 *
 */
 public class FacultyFinalAttendReport extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public FacultyFinalAttendReport() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr><td colspan=150><blockquote><h2>"+Styles.ccase("Report Title : "+"Faculty's Final Attendance")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				...
				while(rs.next())
				{
					...
					kout.println("<tr><td>Record No:<td>Total<td>Lastest Report Date<td>");

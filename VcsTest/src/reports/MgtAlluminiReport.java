...
/**
 * Servlet implementation class for Servlet: MgtAlluminiReport
 *
 */
 public class MgtAlluminiReport extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public MgtAlluminiReport() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Management Who Are Choosen As Allumini In VCS</title></head>");
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr><td colspan=150><blockquote><h2>"+Styles.ccase("Report Title : "+"Management As Allumini")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				...
				while(rs.next())
				{
					...
					kout.println("<tr><td>Sr No:<td>Management Name<td>Gender<td>Qualification<td>Country<td>city<td>");

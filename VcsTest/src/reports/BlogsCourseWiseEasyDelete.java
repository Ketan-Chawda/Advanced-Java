...
/**
 * Servlet implementation class for Servlet: BlogsCourseWiseEasyDelete
 *
 */
 public class BlogsCourseWiseEasyDelete extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public BlogsCourseWiseEasyDelete() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Easy Deletion Of Blogs CourseWise In VCS</title></head>");
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr><td colspan=75%><blockquote><h2>"+Styles.ccase("Operation On : "+" Blogs CourseWise")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				...
				kout.println("<form action='/VcsTest/BlogsCourseWiseEasyHelp' method='post'>");
				...
				while(rs.next())
				{
					...
					kout.println("<tr><td><input type='submit' value='Delete'><td>Total:<td>Blog Id:<td>Given By:<td>Blog Date & Time:<td colspan=8>Blog Message:<td>");

...
/**
 * Servlet implementation class for Servlet: AssignmentCourseWiseEasyHelp
 *
 */
 public class AssignmentCourseWiseEasyHelp extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public AssignmentCourseWiseEasyHelp() {
		super();
	}   	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			{	
			mycon.close();
			response.sendRedirect("/VcsTest/AssignmentCourseWiseEasyDelete");
			}
			}
			else

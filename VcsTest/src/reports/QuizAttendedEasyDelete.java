...
/**
 * Servlet implementation class for Servlet: QuizAttendedEasyDelete
 *
 */
 public class QuizAttendedEasyDelete extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public QuizAttendedEasyDelete() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Easy Deletion Of Student Who Have Attended The Respective Quiz</title></head>");
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr><td colspan=75%><blockquote><h2>"+Styles.ccase("Operation On : "+" Quiz Attendance")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				...
				kout.println("<form action='/VcsTest/QuizAttendedEasyHelp' method='post'>");
				while(rs.next())
				{
					...
					ResultSet rs1=st1.executeQuery("select distinct sid,qdate from student_quiz where qid='"+tqid+"'");
						
					kout.println("<tr><td><input type='submit' value='Delete'><td>Sr No:<td>Student Id<td>Quiz Date<td>");
					k=1;
					while(rs1.next())
					{
					String str=rs1.getString("sid");

...
/**
 * Servlet implementation class for Servlet: StudentPendingEasyDelete
 *
 */
 public class StudentPendingEasyDelete extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public StudentPendingEasyDelete() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Easy Deletion Of Students Whose Request Are Pending For Admission In VCS</title></head>");
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr><td colspan=75%><blockquote><h2>"+Styles.ccase("Operation On : "+" Student's Attendance")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				kout.println("<br><br><br>**************************************************************************************************************</center><br>");
		
				//kout.println("<br><br><h1>Students Whose Request Are Pending For Admission In VCS</h1>");
				...
				kout.println("<form action='/VcsTest/StudentPendingEasyHelp' method='post'>");
				while(rs.next())
				{
					...
					kout.println("<tr><td><input type='submit' value='Delete'><td>Sr No:<td>Student Name<td>Gender<td>Coursename<td>Country<td>City<td>Registration Date<td>");
			...
			if(c==1)
			kout.println("<br><br><br><h1>Sorry No Student's Request Is Pending At Present In VCS");
			}
			catch(Exception k)
			{

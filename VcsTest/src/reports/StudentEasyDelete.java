...
/**
 * Servlet implementation class for Servlet: StudentEasyDelete
 *
 */
 public class StudentEasyDelete extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public StudentEasyDelete() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Easy Deletion Of Student Who Are Currently Studying In VCS</title></head>");
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr><td colspan=75%><blockquote><h2>"+Styles.ccase("Operation On : "+" Student Attendance")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				kout.println("<br><br><br>**************************************************************************************************************</center><br>");
				
				//kout.println("<br><br><h1>Student Who Are Currently Studying In VCS</h1>");
				...
				kout.println("<form action='/VcsTest/StudentEasyHelp' method='post'>");
				while(rs.next())
				{
				...
				if(c==1)
					kout.println("<br><br><br><h1>Sorry No Student Is Currently Studing In VCS");
				}
			catch(Exception k)
			{

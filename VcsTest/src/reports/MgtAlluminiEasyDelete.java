...
/**
 * Servlet implementation class for Servlet: MgtAlluminiEasyDelete
 *
 */
 public class MgtAlluminiEasyDelete extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public MgtAlluminiEasyDelete() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Easy Deletion Of Management Who Are Choosen As Allumini In VCS</title></head>");
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr><td colspan=75%><blockquote><h2>"+Styles.ccase("Operation On : "+" Management's Allumni")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				kout.println("<br><br><br>**************************************************************************************************************</center><br>");
				
				//kout.println("<br><br><h1>Management Who Are Choosen As Allumini In VCS</h1>");
				st=mycon.createStatement();
				ResultSet rs=st.executeQuery("select * from mgt_allumini");
				int c=1;
				kout.println("<center><table align='right' width=95% border=2 bordercolor=black>");
				
				kout.println("<form action='/VcsTest/MgtAlluminiEasyHelp' method='post'>");
				while(rs.next())
				{
					...
					if(c%2==1)
					kout.println("<tr><td colspan=95%><center><h1>Management Id Was: " +str+"</center></h1>");
					else
					kout.println("<tr><td colspan=95%><center><h2>Management Id Was: "+str+"</center></h2>");
					
					kout.println("<tr><td><input type='submit' value='Delete'><td>Sr No:<td>Management Name<td>Gender<td>Qualification<td>Country<td>city<td>");
				...
				if(c==1)
				kout.println("<br><br><br><h1>Sorry No Management Is Selected For Management Allumini Till Now");
			}
			catch(Exception k)
			{

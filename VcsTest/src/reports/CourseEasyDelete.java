...
/**
 * Servlet implementation class for Servlet: CourseEasyDelete
 *
 */
 public class CourseEasyDelete extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public CourseEasyDelete() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Easy Deletion Of Course Available In VCS At Present</title></head>");
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr><td colspan=75%><blockquote><h2>"+Styles.ccase("Operation On : "+" Course")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				kout.println("<br><br><br>**************************************************************************************************************</center><br>");
				
				//kout.println("<br><br><h1>View Course Available In VCS At Present</h1>");
				...
				kout.println("<form action='/VcsTest/CourseEasyHelp' method='post'>");
				...
				while(rs.next())
				{
					...
					if(c%2==1)
					kout.println("<tr><td colspan=95%><center><h1>Course Name :"+str+"</center></h1>");
					else
					kout.println("<tr><td colspan=95%><center><h2>Course Name :"+str+"</center></h2>");
					
					kout.println("<tr><td><input type='submit' value='Delete'><td>Sr No:<td>Total Subjects<td>Starting Date<td>Total Duration<td>");
					
					kout.println("<tr><td><input type='checkbox' name='"+"c"+c+"' value='"+str+"'>");
					
					kout.println("<td>"+c);
					kout.println("<td>"+rs.getString("total_subject"));
					kout.println("<td>"+rs.getString("start_date"));
				...
				if(c==1)
				kout.println("<br><br><br><h1>Sorry No Course Is Declared Or Defined Till Now");
			}
			catch(Exception k)
			{

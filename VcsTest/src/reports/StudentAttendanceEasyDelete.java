...
/**
 * Servlet implementation class for Servlet: StudentAttendanceEasyDelete
 *
 */
 public class StudentAttendanceEasyDelete extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public StudentAttendanceEasyDelete() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Easy Deletion Of Student's Attendance Report In VCS</title></head>");
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr><td colspan=150><blockquote><h2>"+Styles.ccase("Operation On : "+" Student's Attendance")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				kout.println("<br><br><br>**************************************************************************************************************</center><br>");
				//kout.println("<br><br><h1>Student's Attendance Report In VCS</h1>");
		
				st=mycon.createStatement();
				ResultSet rs=st.executeQuery("select * from student_attend");
				int c=1;
				...
				while(rs.next())
				{
					...
					kout.println("<tr><td>Sr No:<td>Course-Name<td>Date<td>Status<td>");

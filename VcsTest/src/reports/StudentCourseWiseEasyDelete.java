...
/**
 * Servlet implementation class for Servlet: StudentCourseWiseEasyDelete
 *
 */
 public class StudentCourseWiseEasyDelete extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public StudentCourseWiseEasyDelete() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Easy Deletion Of Student CourseWise Who Are Currently Studying In VCS</title></head>");
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr><td colspan=75%><blockquote><h2>"+Styles.ccase("Operation On : "+" Student Coursewise")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				...
				kout.println("<form action='/VcsTest/StudentCourseWiseEasyHelp' method='post'>");
				while(rs.next())
				{
					...
					kout.println("<tr><td colspan=100%><center>"+Fortable.display(153,"*"));
					kout.println("<tr><td><input type='submit' value='Delete'><td>Total:<td>Student Name<td>Gender<td>Country<td>City<td>");

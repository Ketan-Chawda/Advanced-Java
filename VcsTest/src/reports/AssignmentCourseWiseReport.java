...
/**
 * Servlet implementation class for Servlet: AssignmentCourseWiseReport
 *
 */
 public class AssignmentCourseWiseReport extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public AssignmentCourseWiseReport() {
		super();
	}  
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Assignment CourseWise Which Are Currently Allocated In VCS</title></head>");
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr><td colspan=150><blockquote><h2>"+Styles.ccase("Report Title : "+" Assignment CourseWise")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				...
				while(rs.next())
				{
					...
					{
					kout.println("<tr><td colspan=100%><center>"+Fortable.display(153,"-"));
					kout.println("<tr <tr colspan=100%><td>Total:<td>Assign Id<td>Allocated On<td>For Subject<td>Total Marks<td>Submission Date<td>");
					kout.println("<tr><td>"+k);
					kout.println("<td>"+rs1.getString("aid"));

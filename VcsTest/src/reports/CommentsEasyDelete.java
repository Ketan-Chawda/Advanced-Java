...
/**
 * Servlet implementation class for Servlet: CommentsEasyDelete
 *
 */
 public class CommentsEasyDelete extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public CommentsEasyDelete() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Easy Deletion Of Comments Of VCS</title></head>");
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr><td colspan=75%><blockquote><h2>"+Styles.ccase("Operation On : "+" Comments")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				...
				while(rs.next())
				{
					...
					while(rs1.next())
					{
					str=rs1.getString("cid");
					kout.println("<tr><td colspan=100%><center><h2>Comment Id:"+str+"</h2></center>");
					
					kout.println("<tr><td><input type='submit' value='Delete'>");
					kout.println("<td><input type='checkbox' name='"+"c"+c+"' value='"+str+"'>");

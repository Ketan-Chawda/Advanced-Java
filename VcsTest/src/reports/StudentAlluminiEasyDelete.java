...
/**
 * Servlet implementation class for Servlet: StudentAlluminiEasyDelete
 *
 */
 public class StudentAlluminiEasyDelete extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public StudentAlluminiEasyDelete() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Easy Deletion Of Student Who Are Chossen For Student Allumini In VCS</title></head>");
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr><td colspan=75%><blockquote><h2>"+Styles.ccase("Operation On : "+" Student's Allumni")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				kout.println("<br><br><br>**************************************************************************************************************</center><br>");
				//kout.println("<br><br><h1>Student Who Are Chossen For Student Allumini In VCS</h1>");
		
				st=mycon.createStatement();
				ResultSet rs=st.executeQuery("select * from student_allumini");
				int c=1;
				kout.println("<center><table align='right' width=95% border=2 bordercolor=black>");
				kout.println("<form action='/VcsTest/StudentAlluminiEasyHelp' method='post'>");
				while(rs.next())
				{
					...
					kout.println("<tr><td><input type='submit' value='Delete'><td>Sr No:<td>Student Name<td>Gender<td>Coursename<td>Country<td>City<td>");
					
					kout.println("<tr><td><input type='checkbox' name='"+"c"+c+"' value='"+str+"'>");
					
					kout.println("<td>"+c);
					kout.println("<td>"+rs.getString("s_fname"));
				...
				if(c==1)
				kout.println("<br><br><br><h1>Sorry No Student Is Selected For Student Allumini Uptill Now");
			}
			catch(Exception k)
			{

...
/**
 * Servlet implementation class for Servlet: ActivityEasyDelete
 *
 */
 public class ActivityEasyDelete extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public ActivityEasyDelete() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			try
			{
				...
				kout.println("<form action='/VcsTest/ActivityEasyHelp' method='post'>");
				while(rs.next())
				{
					...
					kout.println("<tr><td><input type='submit' value='Delete'><td>Sr No:<td>Activity Name<td>Description<td>Organized Date<td>Duration<td>File<td>");

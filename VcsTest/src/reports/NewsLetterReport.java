...
/**
 * Servlet implementation class for Servlet: NewsLetterReport
 *
 */
 public class NewsLetterReport extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public NewsLetterReport() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>View NewsLetter By Admin In VCS</title></head>");
		...
		try
		{
			...
			{	
				...
				kout.println("<tr><td colspan=150><blockquote><h2>"+Styles.ccase("Report Title : "+" NewsLetter")+"<td><h2><a href='javascript:history.go(-1)'>Back</a>");
				kout.println("</table>");
				...
				while(rs.next())
				{
					...
					kout.println("<tr><td>Sr No:<td>News Date<td>NewsLetter Message<td>");

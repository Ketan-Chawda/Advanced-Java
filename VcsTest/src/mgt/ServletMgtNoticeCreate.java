...
/**
 * Servlet implementation class for Servlet: ServletMgtNoticeCreate
 *
 */
 public class ServletMgtNoticeCreate extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public ServletMgtNoticeCreate() {
		super();
	}   	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(mycon!=null)
		{
			try
			{
				...
				query1="select * from countall where role='notice' and entry='"+myear+"'";  
		...
		finally
		{
			...
			kout.println("<form id=vcs method=post action=/VcsTest/Mgt/MgtNoticeCreate.jsp>");

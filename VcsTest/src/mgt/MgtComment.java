 ...
 *
 */
 public class MgtComment extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			...
			try
			{
                ...
                kout.println("<form name=upd id=upd method=post action=/VcsTest/Mgt/MgtCommentCreate.jsp>");
		...
		finally
		{
			...
			kout.println("<form id=vcs method=post action=/VcsTest/Mgt/MgtCommentCreate.jsp>");

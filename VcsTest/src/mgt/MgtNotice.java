 ...
 *
 */
 public class MgtNotice extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			...
			try
			{
                ...
                kout.println("<form name=upd id=upd method=post action=/VcsTest/Mgt/MgtNoticeCreate.jsp>");												
				while(rs.next())
				{					
					cnt++;
					data=rs.getString(1);					

...
/**
 * Servlet implementation class for Servlet: ServletMgtNoticeDelete
 *
 */
 public class ServletMgtNoticeDelete extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public ServletMgtNoticeDelete() {
		super();
	}   	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Notice Deletion By Management</title></head>");
		...
		finally
		{
			...
			kout.println("<form id=vcs method=post action=/VcsTest/Mgt/MgtNoticeDelete.jsp>");

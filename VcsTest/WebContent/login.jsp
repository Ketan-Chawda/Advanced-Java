...
<script language="JavaScript" src="js/textcol.js">
	...
	if(flag_color==true)
	{
	document.getElementById('upass_error').style.color="green";
	flag_color=false;
	}
	else
	{
	document.getElementById('upass_error').style.color="red";
	flag_color=true;
	}
...
<fieldset><legend>
  <h4>Login</h4></legend>
  <br><dd>
  <img src="images/educational-projects-banner.jpg" width="602" height="100">
<form name="login" id="login" method="post"
	action="/VcsTest/ServletSignin">
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	<tr>
		<td width="101"></td>
		<td colspan="3"><input type="text" name="upass_error"
			value="<% if(st!=null){out.println(st);} %>"
			size="40" tabindex="400" id="upass_error"
	...
	<tr>
		<td width="101" style="color: #a52a2a;" height="30">User Name:</td>
		<td colspan="3"><input type="text" name="uname" id="log_uname"
			tabindex="1"
			style="padding: 2px 5px 4px 5px; border: 1px double #0087c1; width: 221px;"
			OnFocus="textbackcolor('log_uname')" OnBlur="textback('log_uname')"></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td colspan="3"></td>
	...
	<tr>
		<td width="101" style="color: #a52a2a" height="30">Password:</td>
		<td colspan="3"><input type="password" name="upass"
			id="log_passwd" tabindex="2"
			style="padding: 2px 5px 4px 5px; border: 1px double #0087c1; width: 221px;"
			OnFocus="textbackcolor('log_passwd')" OnBlur="textback('log_passwd')"></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td colspan="3"></td>
	...
	<tr>
		...
		<td width="157" valign="bottom"><a href="passwd_recover.jsp"
			tabindex="5">Forgot Your Password ?</a></td>
		<td width="64" align="left"><span> <a href="#"
			...
			tabindex="6" class="fright"
			OnClick="document.getElementById('login').submit();">Login</a> </span></td>

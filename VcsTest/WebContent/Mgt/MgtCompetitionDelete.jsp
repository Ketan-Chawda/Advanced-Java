...
<html lang="en">
<head>
<title>Competition Deletion</title>
<meta charset="utf-8">
...
<%
        ...
        out.println("document.getElementById('compid').options[z]=opt;");
        out.println("document.getElementById('compid').options[z].text=item;");
        out.println("document.getElementById('compid').options[z].value=item;");
        out.println("z++;}");
...
<%
        try
		{
			...
			ResultSet rs=stt.executeQuery("select compid from competition_master");
			
			while(rs.next())
			{
				data=rs.getString("compid");
...
<div class="container">
<h1><a href="MgtCompetitionDelete.jsp">Student's site</a></h1>
<nav>
<ul>
...
<h4>Competition Deletion</h4>
</font></legend>
<dd><br>
<form name="recover" id="recover" method="post"
	action="/VcsTest/ServletMgtCompetitionDelete">
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		<td width="103" style="color: #a52a2a">Competition ID:</td>
		<td colspan="3"><select name="compid" id="compid"

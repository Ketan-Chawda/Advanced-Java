...
<%
        ...
        out.println("document.getElementById('cid').options[z]=opt;");
        out.println("document.getElementById('cid').options[z].text=item;");
        out.println("document.getElementById('cid').options[z].value=item;");
        out.println("z++;}");
...
<%
        try
		{
			...
			String trole=request.getAttribute("uid").toString();
			ResultSet rs=stt.executeQuery("select cid from comment_master where cprior>2 or userid='"+trole+"'");
			//ResultSet rs=stt.executeQuery("select cid from comment_master");
			
			while(rs.next())
			{
				data=rs.getString("cid");
...
<div class="container">
<h1><a href="AdminLoginDelete.jsp">Student's site</a></h1>
<nav>
<ul>
	<li><a href="MgtHome.jsp" class="m1">ACTIVITY</a></li>
	<li><a href="MgtCompetition.jsp" class="m2">COMPETITION</a></li>
	<li class="current"><a href="MgtBlogs.jsp" class="m4">BLOGS</a></li>
...
<h3>Categories</h3>
<ul class="categories">
	<li><span><a href="MgtBlogsCreate.jsp">Create Blogs</a></span></li>
	<li><span><a href="MgtBlogsDelete.jsp">Delete Blogs</a></span></li>
	<li><span><a href="MgtCommentCreate.jsp">Comment</a></span></li>
	<li><span><a href="MgtCommentDelete.jsp">Comment Delete</a></span></li>
	<li class="last"><span><a
		href="/VcsTest/CommentsCourseWiseReport">View
	Comments</a></span></li>
</ul>
...
<form name="recover" id="recover" method="post"
	action="/VcsTest/ServletCommentsDelete">
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		<td width="103" " style="color: #a52a2a">Comment ID:</td>
		<td colspan="3" height="30"><select name="cid" id="cid"

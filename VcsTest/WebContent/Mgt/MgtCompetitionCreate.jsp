...
<html lang="en">
<head>
<title>Competition Creation</title>
<meta charset="utf-8">
...
function check(lbl)
{
 ...
 if(lbl=="mgt_act")
 {
     ...
     if(act=="")
     {
         document.getElementById('act_error').value="   * Competition Name Required."
     }
     else
     {
...
<%
String st;
st=request.getParameter("ass_error");
%>
<body id="page1">
<div class="wrap"><!-- header --> <header>
<div class="container">
<div class="container">
<h1><a href="MgtCompetitionCreate.jsp">Student's site</a></h1>
<nav>
<ul>
...
<h4>Competition Creation</h4>
</font></legend>
<dd><br>
<form name="activity" id="activity" method="post"
	action="/VcsTest/ServletMgtCompetitionCreate">
<table name="frm_frm" id="frm_frm" align="center" width="87%">
	...
	<tr>
		<td width="141" style="color: #a52a2a">Competition Name:</td>
		<td height="30" colspan="2"><input type="text" name="compname"
	...
	<tr>
		...
		<td colspan="2"
			...
			name="cdesc" id="act_desc" tabindex="2"
	...
	<tr>
		...
		<td height="30" colspan="2"><input type="text" name="cday"
			...
			name="cmonth" id="reg_bmonth" tabindex="4"
		...
		</select> &nbsp; <input type="text" name="cyear" id="reg_byear" tabindex="5"
			style="padding: 3px 5px 2px 7px; border: 0px solid; background: url(../images/roundedbirth.gif) no-repeat top left; height: 17px; width: 47px;"
	...
	<tr>
		...
		<td colspan="4"><input type="file" name="act_file" id="act_file"

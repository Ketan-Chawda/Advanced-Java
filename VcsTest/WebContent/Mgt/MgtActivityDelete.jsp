...
<%
        ...
        out.println("document.getElementById('actid').options[z]=opt;");
        out.println("document.getElementById('actid').options[z].text=item;");
        out.println("document.getElementById('actid').options[z].value=item;");
        out.println("z++;}");
...
<%
        try
		{
			...
			ResultSet rs=stt.executeQuery("select actid from activity_master");
			
			while(rs.next())
			{
				data=rs.getString("actid");
...
<div class="container">
<h1><a href="MgtActivityDelete.jsp">Student's site</a></h1>
<nav>
<ul>
...
<h4>Activity Deletion</h4>
</font></legend>
<dd><br>
<form name="recover" id="recover" method="post"
	action="/VcsTest/ServletMgtActivityDelete">
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		<td width="103" style="color: #a52a2a">Activity ID:</td>
		<td colspan="3" height="30"><select name="actid" id="actid"

...
<%                
        ...
        {
        out.println("document.getElementById('course').options[1].selected=true;");
...
{
document.getElementById('recover').action="/VcsTest/ServletFacultyNoticeCreate";
document.getElementById('recover').submit();
}
</script>
</head>
...
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		<td height="27"><input type="text" name="lbl_crs" size="10"
			...
			readonly></td>
		<td colspan="3"><select id="course2" name="course2" style="border:1px solid #a52a2a;font-family: arial;color: #FFFFFF;background-color: #26b6e8;visibility:hidden;">
		  </select></td>
	</tr>
	<tr>
		<td>&nbsp;</td>

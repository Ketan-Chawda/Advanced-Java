...
<%
        try
		{
			...
			ResultSet rs=stt.executeQuery("select bid from blog_master where bprior>'3' or userid='"+trole+"'");
...
<div class="container">
<h1><a href="FacultyBlogsDelete.jsp">Student's site</a></h1>
<nav>
<ul>
...
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		...
		<td colspan="3" height="30"><select name="bid" tabindex="1"
			id="bid"

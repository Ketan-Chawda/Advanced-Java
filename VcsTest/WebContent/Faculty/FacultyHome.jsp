...
<html lang="en">
<head>
<title>Home | Welcome To Faculty</title>
<meta charset="utf-8">
...
<nav>
<ul>
	<li class="current"><a href="FacultyHome.jsp" class="m1">LECTURE</a></li>
...
<li><span><a href="/VcsTest/FStep" onClick="">Dynamic Report</a></span></li>


	<li><span><a href="http://localhost:8080/chat1/login.jsp">Group
	Discussion</a></span></li>
	...
	<li><span><a href="/VcsTest/FacultyLectureReport">View Lecture Allocation</a></span></li>
	<li><span><a href="FacultyTakeLecture.jsp">Take Lecture</a></span></li>
	<li><span><a href="FacultyLibrary.jsp">Upload Video</a></span></li>
	<li><span><a href="/VcsTest/StudentAssignmentSubmitReport">Student Assignments</a></span></li>
	<li class="last"><span><a
		href="/VcsTest/FacultyVideoReport">View Upload
	Video</a></span></li>
</ul>
...
<!-- content --> <section id="content"> 
  ...
  <p><img src="../images/welcomebar.gif" alt="" width="681" height="21"></p>
  <p><img src="../images/education_banner (1).jpg" width="688" height="197"><br>
  </p>
  <p></p>
</section></div>
</div>

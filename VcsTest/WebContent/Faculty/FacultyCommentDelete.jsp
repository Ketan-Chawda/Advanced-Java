...
<%
        try
		{
			...
			ResultSet rs=stt.executeQuery("select cid from comment_master where cprior>3 or userid='"+trole+"'");
...
<ul class="categories">
	...
	<li><span><a href="FacultyCommentDelete.jsp">Comment
	Delete</a></span></li>
	<li class="last"><span><a
		href="/VcsTest/CommentsReport">View
	Comments</a></span></li>
</ul>
...
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		...
		<td colspan="3" height="30"><select name="cid" id="cc_course"

...
<html lang="en">
<head>
<title>Assignment Deletion</title>
<meta charset="utf-8">
...
<div class="wrap"><!-- header --> <header>
  <div class="container">
    <h1><a href="FacultyAssignmentDelete.jsp">Student's site</a></h1>
    <nav>
      <ul>
...
<h4>Assignment Deletion</h4>
</font></legend>
<dd><br>
<form name="recover" id="recover" method="post"
	action="/VcsTest/ServletFacultyAssignmentDelete">
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		...
		<td colspan="3" height="30"><select name="aid" id="aid"
			tabindex="1"

...
<html lang="en">
<head>
<title>Articles - Articles | Student's Site - Free Website
...
<div class="container">
<h1><a href="courses.jsp"></a></h1>
<nav>
<ul>
	<li><a href="home.jsp" class="m1">Home </a></li>
	<li class="current"><a href="courses.jsp" class="m2">courses</a></li>
    ...
    <tr>
      <td width="582"><%
        try
		{
			...
			String date="",msg="";
			stt=mycon.createStatement();
			ResultSet rs=stt.executeQuery("select * from course_master");
			...
			out.println("<td>");
			out.println(rs.getString("total_subject"));
			out.println("</td>");			
			...
			out.println("<td>");
			out.println(rs.getString("cdesc"));
			out.println("</td>");			
		...
		%></td>
      <td width="77"><img src="images/online.gif" width="79" height="353"></td>
      </tr>
</table>
<dd>
<dd>

...
<ul class="categories">
	...
	<li><span><a href="AdminNewsCreate.jsp">Create News</a></span></li>
	<li class="last"><span><a href="/VcsTest/NewsLetterReport">Reports</a></span></li>
</ul>
...
<form name="recover" id="recover" method="post"
	action="/VcsTest/ServletAdminNewsLetter">
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		<td width="103" style="color: #a52a2a">News Letter:</td>
		<td colspan="3" style="background: url(../images/roundedbig.gif) no-repeat top left;"><textarea name="nletter" id="news" tabindex="1" style="padding: 3px 5px 2px 7px; border: 0px solid; overflow: auto; background: url(images/roundedbig1.gif) no-repeat top left; height: 79px; width: 215px; color: black"></textarea>
		  <br>
		&nbsp;</td>
	</tr>
	<tr>

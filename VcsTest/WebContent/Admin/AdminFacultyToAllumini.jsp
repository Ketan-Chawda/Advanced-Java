...
<div class="container">
<h1><a href="AdminFacultyToAllumini.jsp">Student's site</a></h1>
<nav>
<ul>
...
<form name="recover" id="recover" method="post"
	action="/VcsTest/ServletAdminFacultyToAllumini">
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		...
		<td colspan="3" height="30"><select name="fid" id="facid"

...
<div class="container">
<h1><a href="AdminStudentToAllumini.jsp">Student's site</a></h1>
<nav>
<ul>
...
<form name="recover" id="recover" method="post"
	action="/VcsTest/ServletAdminStudentToAllumini">
<table name="frm_frm" id="frm_frm" align="center" width="60%">

	<tr>
		<td width="103"></td>
		<td colspan="3"><input type="text" name="rec_error" value="<% if(st!=null){out.println(st);} %>" size="40"
	...
	<tr>
		<td width="103" style="color: #a52a2a">Student ID:</td>
		<td colspan="3" height="30"><select name="sid" id="sid"

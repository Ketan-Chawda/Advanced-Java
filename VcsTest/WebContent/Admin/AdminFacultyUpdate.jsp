...
sid=document.getElementById('fid').value;
...
{	
		if(sid=="--------------Select One-------------")
		{
		document.getElementById('total_error').value="       * Please Select Faculty ID."
		dyn_blnkerror();
		}
		else
		{				
		document.getElementById("register_frm").action="/VcsTest/ServletAdminFacultyUpdate";
...
<%
        String f_id=request.getParameter("sid");
        out.println("<script language=JavaScript>");
        out.println("var z=0;");
        out.println("function course(item){");
        out.println("opt=new Option();");
        out.println("document.getElementById('fid').options[z]=opt;");        
        out.println("document.getElementById('fid').options[z].text=item;");
        out.println("document.getElementById('fid').options[z].value=item;");
        out.println("if(document.getElementById('fid').options[z].text==\""+f_id+"\"){");
        out.println("document.getElementById('fid').options[z].selected=true;}");
        out.println("z++;}");
...
<div class="wrap"><!-- header --> <header>
  <div class="container">
    <h1><a href="AdminFacultyUpdate.jsp">Student's site</a></h1>
    <nav>
      <ul>
...
<table name="rgst" align="center">
	<tr>
		...
		<td colspan="2"><input type="hidden" name="q_role" value="fac">
	...
	<tr>
		<td><span style="color: #a52a2a">Faculty Id:</span></td>
		<td colspan="2"><select name="fid" tabindex="1" id="fid"

...
<%
        ...
        out.println("document.getElementById('noticeto').options[z]=opt;");
        out.println("document.getElementById('noticeto').options[z].text=item;");
        out.println("document.getElementById('noticeto').options[z].value=item;");
        out.println("if(document.getElementById('noticeto').options[z].text==\""+b_id+"\"){");
        out.println("document.getElementById('noticeto').options[z].selected=true;}");
        out.println("z++;}");
...
{
var bid=document.getElementById('noticeto').value;
...
<h3>Categorie
  ...
  s</h3>
<ul class="categories">
	<li><span><a href="AdminCommentCreate.jsp">Comment</a></span></li>
	<li><span><a href="AdminCommentDelete.jsp">Delete Comment</a></span></li>
...
<dd><br>
<form name="recover" id="recover" method="post" action="/VcsTest/ServletAdminComment">
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		...
		<td colspan="3"><select id="noticeto" name="bid"
	...
	<tr>
		...
		<td colspan="3"
			...
			<textarea name="q_desc" id="q_desc" tabindex="3"

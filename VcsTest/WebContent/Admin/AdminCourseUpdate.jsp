...
<%
        ...
        out.println("document.getElementById('cc_course').options[z]=opt;");
        out.println("document.getElementById('cc_course').options[z].text=item;");
        out.println("document.getElementById('cc_course').options[z].value=item;");        
        out.println("z++;}");
        out.println("var p=0;");
        out.println("function sub(item1){");        
        out.println("opt1=new Option();");
        out.println("document.getElementById('cc_alc').options[p]=opt1;");
        out.println("document.getElementById('cc_alc').options[p].text=item1;");
        out.println("document.getElementById('cc_alc').options[p].value=item1;");        
        out.println("p++;}");
...
<%
        try
		{
			...
			String data1="";			
			rs=stt.executeQuery("select fid from faculty_master");
			
			while(rs.next())
			{
				data1=rs.getString("fid");
				out.println("sub('"+data1+"');");
			}
		}
		catch(Exception k)
		{
...
cmonth=document.getElementById('reg_bmonth').value;
...
var sub,fac;
if(course!="" && nos==tsub && cday!="" && cmonth!="" && cyear!="" && (dy!="00" || dm!="00") && cerror=="" && serror=="" && derror=="")
    {
...
<h4>Course Updation</h4></legend>
<dd><br>
<form name="cc" id="cc" method="post"
	action="/VcsTest/ServletAdminCourseUpdate">
<table name="frm_frm" id="frm_frm" align="center" width="82%">
	...
	<tr>
		...
		<td colspan="3"><select name="coursename" id="cc_course"
	...
	<tr>
		...
		<td colspan="5"><select name="tofid" id="cc_alc" tabindex="4"
			style="border: 1px solid #a52a2a; font-family: arial; color: #FFFFFF; background-color: #26b6e8;">
		</select></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td width="52"><input type="button" name="cc_add" id="cc_add"
			tabindex="5" accesskey="a" value="   Add   " OnClick="item_add()">
		</td>
		<td width="82"></td>
		<td>&nbsp;&nbsp; <input type="button" name="cc_rem" id="cc_rem"
			tabindex="6" accesskey="r" value="Remove" OnClick="item_rem()">
		</td>
		<td></td>
		<td></td>
	</tr>
	...
	<tr>
		...
		<td colspan="3"><input type="text" name="sday" id="reg_bday"
			...
			name="smonth" id="reg_bmonth" tabindex="8"
			style="border: 1px solid #a52a2a; font-family: arial; color: #FFFFFF; background-color: #26b6e8;"
		...
		</select> &nbsp; <input type="text" name="syear" id="reg_byear" tabindex="9"
			style="padding: 3px 5px 2px 7px; border: 0px solid; background: url(../images/roundedbirth.gif) no-repeat top left; height: 17px; width: 47px;"
	...
	<tr>
		...
		<td colspan="3"><select name="duryear" id="cc_year" tabindex="10"
			style="border: 1px solid #a52a2a; font-family: arial; color: #FFFFFF; background-color: #26b6e8;">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<select name="durmonth" id="cc_month" tabindex="11"
			style="border: 1px solid #a52a2a; font-family: arial; color: #FFFFFF; background-color: #26b6e8;">
			<option value="00">00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
			<option value="01">01</option>
			<option value="02">02</option>
  ...
  %>
	<tr>
		...
		<td colspan="2" valign="bottom"><span> <a href="#"
			...
			tabindex="12" class="fright" OnClick="resetall('rst')">Reset</a> </span></td>
		<td align="left"><span> <a href="#"
			style="text-transform: uppercase; font-size: .900em; text-decoration: none; float: right; padding: 3px 10px 0 10px; height: 20px; border: 1px solid #a52a2a;"
			tabindex="13" class="fright" OnClick="finalcourse()">Update</a> </span></td>
		<td colspan="2" align="left"></td>
	</tr>
	<tr>
		<td></td>

...
<html lang="en">
<head>
<title>Management Creation</title>
<meta charset="utf-8">
...
<div class="wrap"><!-- header --> <header>
  <div class="container">
    <h1><a href="AdminMgtCreate.jsp">Student's site</a></h1>
    <nav>
      <ul>
  ...
  <b>
  <%out.println(session.getAttribute("uid").toString());%>
  </b></header>
<div class="container"><!-- aside --> <aside>
<h3>&nbsp;</h3>
<h3>Categories</h3>
<ul class="categories">
	<li><span><a href="AdminMgtCreate.jsp">Create
...
<p align="right"><b>
Hi&nbsp;<a href="/VcsTest/ServletSignout" title="Log Out">Log Out</a> </b></p>
<!-- content --> <section id="content">
<fieldset><legend>
<caption><font>
<h4>Management Creation</h4>
</font></caption>
</legend>
<dd><br>

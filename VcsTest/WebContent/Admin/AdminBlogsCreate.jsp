...
<div class="container">
<h1><a href="AdminBlogsCreate.jsp">Student's site</a></h1>
<nav>
<ul>
...
<h4>Blogs Creation</h4>
</font></legend>
<dd><br>
<form name="recover" id="recover" method="post"
	action="/VcsTest/ServletBlogsCreate">
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		<td width="103" style="color: #a52a2a">Blog Message:</td>
		<td colspan="3"
	...
	<tr>
		...
		<td width="75" align="left"><span> <a href="#"
			...
			OnClick="document.getElementById('recover').submit()">Create</a> </span></td>

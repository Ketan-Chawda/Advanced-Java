...
<%
        try
		{
			...
			ResultSet rs=stt.executeQuery("select userid from login_master where locked='no'");
			
			while(rs.next())
			{
				data=rs.getString("userid");
...
<div class="container">
<h1><a href="AdminLoginLock.jsp">Student's site</a></h1>
<nav>
<ul>
...
<h3>Categories</h3>
<ul class="categories">
	<li><span><a href="AdminLoginLock.jsp">Login Lock</a></span></li>
	<li><span><a href="AdminLoginUnlock.jsp">Login Unlock</a></span></li>
	<li><span><a href="AdminLoginDelete.jsp">Login Delete</a></span></li>
	<li class="last"><span><a href="/VcsTest/LoggingReport">Reports</a></span></li>
</ul>
...
<p><img src="../images/warning.gif" width="679" height="14"></p>
...
<form name="recover" id="recover" method="post"
	action="/VcsTest/ServletAdminLoginLock">
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		<td width="103" style="color: #a52a2a">User ID:</td>
		<td colspan="3"><select name="userid" id="cc_course"
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan="3"><input type="hidden" name="locked" value="Yes"
			id="hiddenField"></td>
	</tr>
	<tr>
		<td></td>
		...
		<td width="75" align="left"><span> <a href="#"
			...
			OnClick="document.getElementById('recover').submit()">Lock</a> </span></td>

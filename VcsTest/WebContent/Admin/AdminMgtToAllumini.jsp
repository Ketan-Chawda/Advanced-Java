...
<div class="container">
<h1><a href="AdminMgtToAllumini.jsp">Student's site</a></h1>
<nav>
<ul>
...
<h4>Management Alumni</h4>
</font></legend>
<dd><br>
<form name="recover" id="recover" method="post"
	action="/VcsTest/ServletAdminMgtToAllumini">
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		<td width="103" style="color: #a52a2a">Management ID:</td>
		<td colspan="3"><select name="mid" id="mid"
	...
	<tr>
		...
		<td width="83" align="left"><span> <a href="#"
			...
			OnClick="document.getElementById('recover').submit()">Alumni</a> </span></td>

...
<%
        try
		{
			...
			ResultSet rs=stt.executeQuery("select userid from login_master");
...
<form name="recover" id="recover" method="post"
	action="/VcsTest/ServletAdminLoginDelete">
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		...
		<td colspan="3" height="30"><select name="userid" id="userid"

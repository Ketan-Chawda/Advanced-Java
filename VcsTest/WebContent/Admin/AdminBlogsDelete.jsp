...
<%
        ...
        out.println("document.getElementById('blog').options[z]=opt;");
        out.println("document.getElementById('blog').options[z].text=item;");
        out.println("document.getElementById('blog').options[z].value=item;");
        out.println("z++;}");
...
<%
        try
		{
			...
			ResultSet rs=stt.executeQuery("select * from blog_master");
...
<div class="container">
<h1><a href="AdminBlogsDelete.jsp">Student's site</a></h1>
<nav>
<ul>
	...
	<li class="current"><a href="AdminBlogs.jsp" class="m5">BLOGS</a></li>
...
<h3>Categories</h3>
<ul class="categories">
	<li><span><a href="AdminBlogsCreate.jsp">Create Blog</a></span></li>
	<li><span><a href="AdminBlogsDelete.jsp">Delete Blog</a></span></li>
	<li><span><a href="/VcsTest/StudentBlogsReport"> Student Blog</a></span></li>
	<li><span><a href="/VcsTest/FacultyBlogsReport"> Faculty Blog</a></span></li>
	<li><span><a href="/VcsTest/MgtBlogsReport">Management
	Blog</a></span></li>
	<li class="last"><span><a href="/VcsTest/BlogsReport">Reports</a></span></li>
</ul>
...
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		...
		<td colspan="3" height="30"><select name="bid" id="blog"

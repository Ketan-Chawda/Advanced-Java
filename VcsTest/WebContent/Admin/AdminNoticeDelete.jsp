...
<%
        ...
        out.println("document.getElementById('noticeid').options[z]=opt;");
        out.println("document.getElementById('noticeid').options[z].text=item;");
        out.println("document.getElementById('noticeid').options[z].value=item;");
        out.println("z++;}");
...
<%
        try
		{
			...
			ResultSet rs=stt.executeQuery("select nid from notice");
...
<h3>Categories</h3>
<ul class="categories">
	<li><span><a href="AdminNoticeCreate.jsp">Create Notice</a></span></li>
	<li><span><a href="AdminNoticeDelete.jsp">Delete Notice</a></span></li>
	<li class="last"><span><a href="/VcsTest/NoticeReport">Reports</a></span></li>
</ul>
...
<fieldset><legend>
<h4>Notice Deletion</h4></legend>
<dd><br>
<form name="recover" id="recover" method="post"
	action="/VcsTest/ServletAdminNoticeDelete">
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		...
		<td colspan="3"><select name="nid" id="noticeid"

...
<%
        ...
        out.println("document.getElementById('userid').options[z]=opt;");
        out.println("document.getElementById('userid').options[z].text=item;");
        out.println("document.getElementById('userid').options[z].value=item;");
        out.println("z++;}");
...
<%
        try
		{
			...
			ResultSet rs=stt.executeQuery("select userid from login_master where locked='yes'");
...
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		...
		<td colspan="3"><select name="userid" id="userid"
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan="3"><input type="hidden" name="locked" value="No"
			id="hiddenField"></td>
	</tr>
	<tr>
		<td></td>
		...
		<td width="75" align="left"><span> <a href="#"
			...
			OnClick="document.getElementById('recover').submit()">Unlock</a> </span></td>

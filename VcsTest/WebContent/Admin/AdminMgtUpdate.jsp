...
<html lang="en">
<head>
<title>Management Updation</title>
<meta charset="utf-8">
...
sid=document.getElementById('mid').value;
...
{	
		if(sid=="--------------Select One-------------")
		{
		document.getElementById('total_error').value="          * Please Select Mgt ID."
		dyn_blnkerror();
		}
		else
		{				
		document.getElementById("register_frm").action="/VcsTest/ServletAdminMgtUpdate";
...
<%
        ...
        out.println("document.getElementById('mid').options[z]=opt;");        
        out.println("document.getElementById('mid').options[z].text=item;");
        out.println("document.getElementById('mid').options[z].value=item;");
        out.println("if(document.getElementById('mid').options[z].text==\""+s_id+"\"){");
        out.println("document.getElementById('mid').options[z].selected=true;}");
        out.println("z++;}");
...
<%
        try
		{
			...
			ResultSet rs=stt.executeQuery("select mid from mgt_master");
...
<div class="wrap"><!-- header --> <header>
  <div class="container">
    <h1><a href="AdminMgtUpdate.jsp">Student's site</a></h1>
    <nav>
      <ul>
        <li><a href="AdminHome.jsp" class="m1">STUDENT</a></li>
        <li><a href="AdminFaculty.jsp" class="m2">FACULTY</a></li>
        <li class="current"><a href="AdminMgt.jsp" class="m3">MANAGEMENT</a></li>
...
<h3>Categories</h3>
<ul class="categories">
	<li><span><a href="AdminMgtUpdate.jsp">Edit Management
	Info</a></span></li>
	<li><span><a href="AdminMgtDelete.jsp">Delete
	Management</a></span></li>
	<li><span><a href="AdminMgtToAllumini.jsp">To
	Management Alumni</a></span></li>
	<li class="last"><span><a href="/VcsTest/MgtReport">Reports</a></span></li>
</ul>
...
<table name="rgst" align="center">
	<tr>
		<td height="22" style="color: #a52a2a">&nbsp;</td>
		<td colspan="2"><input type="hidden" name="q_role" value="mgt">
		<input type="text" id="total_error" value="<%if(st!=null){out.println(st);} %>" size="35"
			style="background: url(images/errorbg.jpg) no-repeat top left; color: red; border: 0px solid; height: 20px; font-family: Trebuchet MS;"
			readonly></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		<td><span style="color: #a52a2a">Mgt Id:</span></td>
		<td colspan="2"><select name="mid" tabindex="1" id="mid"

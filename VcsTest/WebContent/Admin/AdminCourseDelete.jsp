...
<div class="container">
<h1><a href="AdminCourseDelete.jsp">Student's site</a></h1>
<nav>
<ul>
...
<h4>Course Deletion</h4>
</font></legend>
<dd><br>
<form name="recover" id="recover" method="post"
	action="/VcsTest/ServletAdminCourseDelete">
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		<td width="103" " style="color: #a52a2a">Course Name:</td>
		<td colspan="3" height="30"><select name="coursename"
			id="cc_course"

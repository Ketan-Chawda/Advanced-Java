...
<%        
        ...
        {
        out.println("document.getElementById('course').options[4].selected=true;");
...
{
document.getElementById('recover').action="/VcsTest/ServletAdminNoticeCreate";
document.getElementById('recover').submit();
}
</script>
</head>
...
<form name="recover" id="recover" method="post"
	action="/VcsTest/ServletNoticeCourse">
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		...
		<td colspan="3"
			...
			style="padding: 3px 5px 2px 7px; border: 0px solid; overflow: auto; background: url(images/roundedbig1.gif) no-repeat top left; height: 79px; width: 215px; color: black"></textarea>
		<br>
		&nbsp;</td>
	</tr>
	<tr>

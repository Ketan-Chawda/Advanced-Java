...
<html lang="en">
<head>
<title>Competition Participate</title>
<meta charset="utf-8">
...
<%
        ...
        out.println("document.getElementById('compname').options[z]=opt;");
        out.println("document.getElementById('compname').options[z].text=item;");
        out.println("document.getElementById('compname').options[z].value=item;");
        out.println("z++;}");
...
<%
        try
		{
			...
			ResultSet rs=stt.executeQuery("select compname from competition_master");
			
			while(rs.next())
			{
				data=rs.getString("compname");
...
<ul>
	...
	<li class="current"><a href="StudCompetition.jsp" class="m5">COMPETITION</a></li>
...
<ul class="categories">
	...
	<li><span><a href="/VcsTest/CompetitionReport">View All Competitions</a></span></li>
	<li><span><a href="StudCompetitionParticipate.jsp">Participate</a></span></li>
</ul>
...
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		<td width="126" style="color: #a52a2a">Competition Name:</td>
		<td colspan="3" height="30"><select name="compname" id="compname"
	...
	<tr>
		<td></td>
		<td width="103"></td>
		<td width="102" align="left"><span> <a href="#"

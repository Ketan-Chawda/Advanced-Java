...
<ul class="categories">
	...
	<li><span><a href="StudAttendLecture.jsp">Attend
	Lectures</a></span></li>
	<li><span><a href="StudOfflineLecture.jsp">View Offline
	Lecture</a></span></li>
	<li class="last"><span><a
		href="/VcsTest/StudentAttendanceReport">View
	Attendance</a></span></li>
</ul>

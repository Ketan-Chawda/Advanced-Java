...
<dd><br>
<form name="recover" id="recover" method="post" action="/VcsTest/StudComment">
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		...
		<td colspan="3"
			...
			style="padding: 3px 5px 2px 7px; border: 0px solid; overflow: auto; color: black; background: url(images/roundedbig1.gif) no-repeat top left; height: 79px; width: 215px;"

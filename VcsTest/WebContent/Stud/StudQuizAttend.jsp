...
function finalquiz()
{
window.open("/VcsTest/ServletQuiz");
}
</script>
<% int p=0;%>
...
<ul>
	...
	<li class="current"><a href="StudQuiz.jsp" class="m2">QUIZ</a></li>
...
<ul class="categories">
	...
	<li><span><a href="/VcsTest/QuizReport">View
	Quiz</a></span></li>
	<li><span><a href="StudQuizAttend.jsp">Attend Quiz</a></span></li>
	<li class="last"><span><a href="/VcsTest/QuizResultReport">Quiz Results</a></span></li>
</ul>
...
<table name="frm_frm" id="frm_frm" align="center" width="60%">
	...
	<tr>
		...
		<td width="75" align="left"><span> <a href="#"
			...
			tabindex="3" class="fright" OnClick="finalquiz();">Attend</a> </span></td>
...
<dd>
<dd><br>
  <img src="../images/education-banner.gif" width="686" height="160"><br>
</fieldset>
</section></div>
</div>
<!-- footer -->

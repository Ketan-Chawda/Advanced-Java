...
<%
        ...
        out.println("document.getElementById('aid').options[z]=opt;");
        out.println("document.getElementById('aid').options[z].text=item;");
        out.println("document.getElementById('aid').options[z].value=item;");
        out.println("z++;}");
...
function ass_final()
{
    var ass=document.getElementById('lfile').value;
    document.getElementById('lfile').value="";
    if(ass!="")
    {    	
        document.getElementById('ass_sub').submit();
    }
    else
    {
        document.getElementById('total_error').value="       * File Path Required.";        
    }
}
...
%>
<body id="page1" OnLoad="starter();dyn_blnkerror()">
...
<ul class="categories">
	...
	<li class="last"><span><a href="StudAssignmentSubmit.jsp">Submit
	Assignment</a></span></li>
</ul>
...
<h4>Assignment Submit</h4>
</font></legend>
<dd><br>
<form name="ass_sub" id="ass_sub" method="post"
	action="/VcsTest/ServletSubmitAssign">
<table name="frm_frm" id="frm_frm" align="center" width="87%">
	<tr>
		<td width="103"></td>
		<td colspan="6"><input type="text" name="total_error" size="70"
			tabindex="400" value="<% if(st!=null){out.println(st);} %>"
			id="total_error"
	...
	<tr>
		...
		<td width="103" style="color: #a52a2a">Assignment ID:</td>
		<td colspan="3"><select name="aid" id="aid" tabindex="1"
	...
	<tr>
		<td width="103" style="color: #a52a2a">File:</td>
		<td colspan="3"><input type="file" name="lfile" id="lfile"
			tabindex="2"
			style="padding: 2px 5px 4px 5px; border: 1px double #0087c1; width: 321px;">
	...
	<tr>
		...
		<td width="71"><span> <a href="#"
			...
			tabindex="3" class="fright" OnClick="ass_final()">Submit</a> </span></td>
		<td width="72"></td>
		<td width="167"></td>
